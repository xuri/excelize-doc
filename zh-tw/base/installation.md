...
使用最新版本 Excelize 要求您使用的 Go 語言為 1.18 或更高版本。請注意，Go 1.21.0 中存在[不兼容的更改](https://github.com/golang/go/issues/61881)，導致 Excelize 基礎庫無法在該版本上正常工作，如果您使用的是 Go 1.21.x，請升級到 Go 1.21.1 及更高版本。
