# 成交量-最高價-最低價-收盤價股價圖 {#stockVolumeHighLowClose}

例如，創建如下效果的成交量-最高價-最低價-收盤價股價圖：

<p align="center"><img width="823" src="../images/stock_volume_high_low_close_chart.png" alt="使用 Go 語言在 Excel 檔案中創建成交量-最高價-最低價-收盤價股價圖"></p>
