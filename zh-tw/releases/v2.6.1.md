...
* 新增更新超連結支援，相關 issue [#1217](https://github.com/xuri/excelize/issues/1217)
...
* 透過 `DeleteDataValidation` 函式刪除資料驗證時，支援省略第二個引用區域參數以刪除工作表中的全部資料驗證，相關 issue [#1254](https://github.com/xuri/excelize/issues/1254)
