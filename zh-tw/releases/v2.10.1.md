...
* 修復 v2.10.0 中引入的問題，解決 `GetCellValue` 與 `GetRows` 函式在某些情況下讀取空白存儲格時，錯誤地傳回了共享字符串索引，相關 issue [#2240](https://github.com/xuri/excelize/issues/2240)
...
* 修復部分情況下，開啓帶有密碼保護的加密活頁簿時，發生 panic 的問題，相關 issue [#2237](https://github.com/xuri/excelize/issues/2237)
...
* 修復使用默認字型或填滿格式創建樣式時，重復創建樣式的問題，相關 issue [#2254](https://github.com/xuri/excelize/issues/2254)
