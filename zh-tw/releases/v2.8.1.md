...
* 設定條件式格式函式 `SetConditionalFormat` 支援批量為多個存儲格區域設定條件式格式，相關 issue [#1783](https://github.com/xuri/excelize/issues/1783)
* 重命名工作表時支援更新自定義名稱，相關 issue [#1792](https://github.com/xuri/excelize/issues/1792)
* 新增 `GetBaseColor` 函式，支援讀取首選十六進制顏色代碼，相關 issue [#1794](https://github.com/xuri/excelize/issues/1794)
* 公式計算引擎支援讀取日期類型存儲格的值，相關 issue [#1807](https://github.com/xuri/excelize/issues/1807)
* 存儲格值讀取函式支援繼承使用 `OpenReader` 函式打開文檔時所指定的 `Options` 選項設定，相關 issue [#1815](https://github.com/xuri/excelize/issues/1815)
...
* 提升了存储格註解圖形与 KingSoft WPS&trade; Office 的兼容性，相关 issue [#1789](https://github.com/xuri/excelize/issues/1789)
