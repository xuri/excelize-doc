...
* `SetCellHyperLink` 支援設定螢幕提示文字與顯示文字，相關 issue [#790](https://github.com/xuri/excelize/issues/790)
...
* 修復部分情況下 `GetColWidth` 傳回默認欄寬錯誤的問題
* 修復無法透過 Excel 電子錶格應用程式向創建的樞紐分析表中添加時間軸與交叉分析篩選器的問題，解決 issue [#804](https://github.com/xuri/excelize/issues/804)
