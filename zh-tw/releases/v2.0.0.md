...
* 工作表頁面佈局設定函數 [`SetPageLayout()`](https://pkg.go.dev/github.com/360EntSecGroup-Skylar/excelize/v2@v2.0.0#File.SetPageLayout) 新增對頁面佈局方向設定的支持，解決了相關 issue [#318](https://github.com/xuri/excelize/issues/318)
...
* 修復通過獲取註解函數 [`GetComment()`](https://pkg.go.dev/github.com/360EntSecGroup-Skylar/excelize/v2@v2.0.0#File.GetComment)，從包含多個工作表的活頁簿獲取註解時，返回了錯誤的工作表名稱的問題，解決了相關 issue [#345](https://github.com/xuri/excelize/issues/345)
