...
* 工作表页面布局设置函数 [`SetPageLayout()`](https://pkg.go.dev/github.com/360EntSecGroup-Skylar/excelize/v2@v2.0.0#File.SetPageLayout) 新增对页面布局方向设置的支持，解决了相关 issue [#318](github.com/xuri/excelize/issues/318)
...
* 修复通过获取批注函数 [`GetComment()`](https://pkg.go.dev/github.com/360EntSecGroup-Skylar/excelize/v2@v2.0.0#File.GetComment)，从包含多个工作表的工作簿获取批注时，返回了错误的工作表名称的问题，解决了相关 issue [#345](github.com/xuri/excelize/issues/345)
