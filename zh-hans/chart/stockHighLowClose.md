# 最高价-最低价-收盘价股价图 {#stockHighLowClose}

例如，创建如下效果的最高价-最低价-收盘价股价图：

<p align="center"><img width="770" src="../images/stock_high_low_close_chart.png" alt="使用 Go 语言在 Excel 文档中创建最高价-最低价-收盘价股价图"></p>
