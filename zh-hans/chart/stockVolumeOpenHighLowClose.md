# 成交量-开盘价-最高价-最低价-收盘价股价图 {#stockVolumeOpenHighLowClose}

例如，创建如下效果的成交量-开盘价-最高价-最低价-收盘价股价图：

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="使用 Go 语言在 Excel 文档中创建成交量-开盘价-最高价-最低价-收盘价股价图"></p>
