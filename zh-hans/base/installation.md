...
使用最新版本 Excelize 要求您使用的 Go 语言为 1.25.0 或更高版本。请注意，Go 1.21.0 中存在[不兼容的更改](https://github.com/golang/go/issues/61881)，导致 Excelize 基础库无法在该版本上正常工作，如果您使用的是 Go 1.21.x 和 Excelize 的早期版本，请升级到 Go 1.21.1 及更高版本。
