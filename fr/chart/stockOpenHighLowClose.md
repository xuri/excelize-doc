# Graphique boursier Open-Haut-Bas-Fermé {#stockOpenHighLowClose}

Par exemple, ajoutez un graphique Graphique boursier Open-Haut-Bas-Fermé comme celui-ci:

<p align="center"><img width="823" src="../images/stock_open_high_low_close_chart.png" alt="créer Graphique boursier Open-Haut-Bas-Fermé avec excelize en utilisant Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Feuil1", "F1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {Text: "Graphique boursier Open-Haut-Bas-Fermé"},
        },
