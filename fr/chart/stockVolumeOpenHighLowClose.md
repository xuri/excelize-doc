# Graphique boursier Volume-Ouverture-Haut-Bas-Clôture {#stockVolumeOpenHighLowClose}

Par exemple, ajoutez un graphique Graphique boursier Volume-Ouverture-Haut-Bas-Clôture comme celui-ci:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="créer Graphique boursier Volume-Ouverture-Haut-Bas-Clôture avec excelize en utilisant Go"></p>
...
func main() {
    ...
    for idx, row := range [][]interface{}{
        {"Date", "Volume", "Ouverture", "Haut", "Bas", "Fermeture"},
    ...
    if err := f.AddChart("Feuil1", "G1", &excelize.Chart{
        Type: excelize.Col,
        Series: []excelize.ChartSeries{
            {
                Name:       "Feuil1!$B$1",
                Categories: "Feuil1!$A$2:$A$22",
                Values:     "Feuil1!$B$2:$B$22",
            },
        },
        ...
        Title: []excelize.RichTextRun{
            {Text: "Graphique boursier Volume-Ouverture-Haut-Bas-Clôture"},
        },
    }, &excelize.Chart{
        ...
        Series: []excelize.ChartSeries{
            {
                Name:       "Feuil1!$C$1",
                Categories: "Feuil1!$A$2:$A$22",
                Values:     "Feuil1!$C$2:$C$22",
            },
            {
                Name:       "Feuil1!$D$1",
                Categories: "Feuil1!$A$2:$A$22",
                Values:     "Feuil1!$D$2:$D$22",
            },
            {
                Name:       "Feuil1!$E$1",
                Categories: "Feuil1!$A$2:$A$22",
                Values:     "Feuil1!$E$2:$E$22",
            },
            {
                Name:       "Feuil1!$F$1",
                Categories: "Feuil1!$A$2:$A$22",
                Values:     "Feuil1!$F$2:$F$22",
            },
        },
