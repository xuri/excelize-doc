# Graphique boursier Haut-Bas-Fermé {#stockHighLowClose}

Par exemple, ajoutez un graphique Graphique boursier Haut-Bas-Fermé comme celui-ci:

<p align="center"><img width="770" src="../images/stock_high_low_close_chart.png" alt="créer Graphique boursier Haut-Bas-Fermé avec excelize en utilisant Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Feuil1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {Text: "Graphique boursier Haut-Bas-Fermé"},
        },
