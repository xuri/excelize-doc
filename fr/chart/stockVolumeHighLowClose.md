# Graphique boursier Volume-Haut-Bas-Clôture {#stockVolumeHighLowClose}

Par exemple, ajoutez un graphique Graphique boursier Volume-Haut-Bas-Clôture comme celui-ci:

<p align="center"><img width="823" src="../images/stock_volume_high_low_close_chart.png" alt="créer Graphique boursier Volume-Haut-Bas-Clôture avec excelize en utilisant Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Feuil1", "F1", &excelize.Chart{
        Type: excelize.Col,
        ...
        Title: []excelize.RichTextRun{
            {Text: "Graphique boursier Volume-Haut-Bas-Clôture"},
        },
    }, &excelize.Chart{
