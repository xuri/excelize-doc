...
* Changer la signature de 9 fonctions:
...
* 5 nouvelles erreurs exportées `ErrStreamSetPanes`, `ErrSheetNameBlank`, `ErrSheetNameInvalid`, `ErrSheetNameLength` et `ErrSheetNameSingleQuote` ont été ajoutées
