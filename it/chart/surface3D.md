# Grafico di superficie 3D {#surface3D}

Ad esempio, aggiungi un grafico a superficie 3D come questo:

<p align="center"><img width="770" src="../images/3d_surface_chart.png" alt="crea un grafico a superficie 3D con Excelize utilizzando Go"></p>
