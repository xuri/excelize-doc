# Grafico di superficie wireframe 3D {#wireframeSurface3D}

Ad esempio, aggiungi un grafico a superficie wireframe 3D come questo:

<p align="center"><img width="770" src="../images/3d_wireframe_contour_chart.png" alt="crea un grafico a superficie wireframe 3D con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico di superficie wireframe 3D",
            },
        },
    }); err != nil {
        fmt.Println(err)
