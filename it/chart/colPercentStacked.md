# Istogramma in pila 2D al 100% {#colPercentStacked}

Ad esempio, aggiungi un istogramma in pila 2D al 100% come questo:

<p align="center"><img width="770" src="../images/2d_percent_stacked_column_chart.png" alt="crea un istogramma in pila 2D al 100% con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico a colonne in pila 2D al 100%",
            },
        },
