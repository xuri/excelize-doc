# Grafico ad area 2D {#area}

Ad esempio, aggiungi un grafico ad area 2D come questo:

<p align="center"><img width="770" src="../images/2d_area_chart.png" alt="creare un grafico ad area 2D con Excelize utilizzando Go"></p>
