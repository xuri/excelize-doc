# Grafico azionario Alto-Basso-Chiusura {#stockHighLowClose}

Ad esempio, aggiungi un Grafico azionario Alto-Basso-Chiusura come questo:

<p align="center"><img width="770" src="../images/stock_high_low_close_chart.png" alt="crea un Grafico azionario Alto-Basso-Chiusura con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {Text: "Grafico azionario Alto-Basso-Chiusura"},
        },
