# Grafico azionario Volume-Alto-Basso-Chiusura {#stockVolumeHighLowClose}

Ad esempio, aggiungi un Grafico azionario Volume-Alto-Basso-Chiusura come questo:

<p align="center"><img width="823" src="../images/stock_volume_high_low_close_chart.png" alt="crea un Grafico azionario Volume-Alto-Basso-Chiusura con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "F1", &excelize.Chart{
        Type: excelize.Col,
        ...
        Title: []excelize.RichTextRun{
            {Text: "Grafico azionario Volume-Alto-Basso-Chiusura"},
        },
    }, &excelize.Chart{
