# Grafico a barre in pila 2D {#barStacked}

Ad esempio, aggiungi un grafico a barre in pila 2D come questo:

<p align="center"><img width="770" src="../images/2d_stacked_bar_chart.png" alt="creare un grafico a barre in pila 2D con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico a barre in pila 2D",
            },
        },
