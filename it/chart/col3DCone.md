# Istogramma a cono 3D {#col3DCone}

Ad esempio, aggiungi un istogramma a cono 3D come questo:

<p align="center"><img width="770" src="../images/3d_cone_column_chart.png" alt="creare un istogramma a cono 3D con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico a colonne a cono 3D",
            },
        },
