# Grafico azionario Volume-Apertura-Massimo-Minimo-Chiusura {#stockVolumeOpenHighLowClose}

Ad esempio, aggiungi un Grafico azionario Volume-Apertura-Massimo-Minimo-Chiusura come questo:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="crea un Grafico azionario Volume-Apertura-Massimo-Minimo-Chiusura con Excelize utilizzando Go"></p>
...
func main() {
    ...
    for idx, row := range [][]interface{}{
        {"Data", "Volume", "Apertura", "Alto", "Basso", "Chiusura"},
    ...
    if err := f.AddChart("Foglio1", "G1", &excelize.Chart{
        Type: excelize.Col,
        Series: []excelize.ChartSeries{
            {
                Name:       "Foglio1!$B$1",
                Categories: "Foglio1!$A$2:$A$22",
                Values:     "Foglio1!$B$2:$B$22",
            },
        },
        ...
        Title: []excelize.RichTextRun{
            {Text: "Grafico azionario Volume-Apertura-Massimo-Minimo-Chiusura"},
        },
    }, &excelize.Chart{
        ...
        Series: []excelize.ChartSeries{
            {
                Name:       "Foglio1!$C$1",
                Categories: "Foglio1!$A$2:$A$22",
                Values:     "Foglio1!$C$2:$C$22",
            },
            {
                Name:       "Foglio1!$D$1",
                Categories: "Foglio1!$A$2:$A$22",
                Values:     "Foglio1!$D$2:$D$22",
            },
            {
                Name:       "Foglio1!$E$1",
                Categories: "Foglio1!$A$2:$A$22",
                Values:     "Foglio1!$E$2:$E$22",
            },
            {
                Name:       "Foglio1!$F$1",
                Categories: "Foglio1!$A$2:$A$22",
                Values:     "Foglio1!$F$2:$F$22",
            },
        },
