# Istogramma in pila 2D {#colStacked}

Ad esempio, aggiungi un istogramma in pila 2D come questo:

<p align="center"><img width="770" src="../images/2d_stacked_column_chart.png" alt="creare un istogramma in pila 2D con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico a colonne in pila 2D",
            },
        },
