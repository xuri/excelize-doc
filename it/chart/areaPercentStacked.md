# Grafico ad area in pila 2D al 100% {#areaPercentStacked}

Ad esempio, aggiungi un grafico ad area in pila 2D al 100% come questo:

<p align="center"><img width="770" src="../images/2d_percent_stacked_area_chart.png" alt="crea un grafico ad area in pila 2D al 100% con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico ad area in pila 2D al 100%",
            },
        },
