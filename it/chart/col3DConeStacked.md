# Istogramma in pila a cono 3D {#col3DConeStacked}

Ad esempio, aggiungi un istogramma in pila a cono 3D come questo:

<p align="center"><img width="770" src="../images/3d_cone_stacked_column_chart.png" alt="creare un istogramma in pila a cono 3D con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico a colonne in pila a cono 3D",
            },
        },
