# Istogramma a colonne in pila a cilindri 3D {#col3DCylinderStacked}

Ad esempio, aggiungi un istogramma in pila a cilindri 3D come questo:

<p align="center"><img width="770" src="../images/3d_cylinder_stacked_column_chart.png" alt="creare un istogramma in pila a cilindri 3D con Excelize utilizzando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Foglio1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Grafico a colonne in pila a cilindro 3D",
            },
        },
