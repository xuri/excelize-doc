# Grafico a colonne 3D {#col3D}

Ad esempio, aggiungi un istogramma 3D come questo:

<p align="center"><img width="770" src="../images/3d_column_chart.png" alt="crea un istogramma 3D con Excelize utilizzando Go"></p>
