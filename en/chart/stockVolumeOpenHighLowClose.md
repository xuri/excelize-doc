# Volume-Open-High-Low-Close stock chart {#stockVolumeOpenHighLowClose}

For example, add a Volume-Open-High-Low-Close stock chart that like the this:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="create Volume-Open-High-Low-Close stock chart with excelize using Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Sheet1", "G1", &excelize.Chart{
        ...
        XAxis: excelize.ChartAxis{
            NumFmt: excelize.ChartNumFmt{CustomNumFmt: "d-mmm-yy"},
        },
        YAxis: excelize.ChartAxis{
            NumFmt: excelize.ChartNumFmt{CustomNumFmt: "#,##0"},
        },
        Title: []excelize.RichTextRun{
            {Text: "Volume-Open-High-Low-Close Stock Chart"},
        },
    }, &excelize.Chart{
