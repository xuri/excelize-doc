# Open-High-Low-Close stock chart {#stockOpenHighLowClose}

For example, add a Open-High-Low-Close stock chart that like the this:

<p align="center"><img width="823" src="../images/stock_open_high_low_close_chart.png" alt="create Open-High-Low-Close stock chart with excelize using Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Sheet1", "F1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {Text: "Open-High-Low-Close Stock Chart"},
        },
