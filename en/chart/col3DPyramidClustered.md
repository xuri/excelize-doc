...
<p align="center"><img width="770" src="../images/3d_pyramid_clustered_column_chart.png" alt="create 3D pyramid clustered column chart with excelize using Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Sheet1", "E1", `{
        ...
        "title":
        {
            "name": "3D Pyramid Clustered Column Chart"
        },
        "plotarea":
        {
