# High-Low-Close stock chart {#stockHighLowClose}

For example, add a High-Low-Close stock chart that like the this:

<p align="center"><img width="770" src="../images/stock_high_low_close_chart.png" alt="create High-Low-Close stock chart with excelize using Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Sheet1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {Text: "High-Low-Close Stock Chart"},
        },
