...
SetPanes предоставляет функцию для создания и удаления стоп-панелей и разделенных панелей по заданному имени рабочего листа и параметрам панелей для `StreamWriter`. Обратите внимание, что вы должны вызывать функцию `SetPanes` перед функцией [`SetRow`](stream.md#SetRow).
