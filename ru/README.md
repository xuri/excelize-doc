...
- Последняя версия: [v2.10.1](https://github.com/xuri/excelize/releases/latest)
- Время обновления документа: 25 февраля 2026 г.
