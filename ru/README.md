...
- Последняя версия: [v1.4.1](https://github.com/360EntSecGroup-Skylar/excelize/releases/latest)
- Время обновления документа: 1 февраль 2019 г.
