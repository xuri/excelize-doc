...
- Последняя версия: [v2.11.0](https://github.com/xuri/excelize/releases/latest)
- Время обновления документа: 14 Август 2026 г.
