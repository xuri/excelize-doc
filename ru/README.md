...
- Последняя версия: [v2.7.0](https://github.com/xuri/excelize/releases/latest)
- Время обновления документа: 1 апреля 2023 г.
