...
- Последняя версия: [v2.9.0](https://github.com/xuri/excelize/releases/latest)
- Время обновления документа: 23 Январь 2025 г.
