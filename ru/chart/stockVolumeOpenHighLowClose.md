# График акций Объем-Открытие-Максимум-Минимум-Закрытие {#stockVolumeOpenHighLowClose}

Например, добавьте букву График акций Объем-Открытие-Максимум-Минимум-Закрытие, которая выглядит так:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="создать График акций Объем-Открытие-Максимум-Минимум-Закрытие с Excelize с помощью Go"></p>
...
func main() {
    ...
    for idx, row := range [][]interface{}{
        {"Дата", "Объем", "Открытие", "Максимум", "Минимум", "Закрытие"},
    ...
    if err := f.AddChart("Лист1", "G1", &excelize.Chart{
        Type: excelize.Col,
