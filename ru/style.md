...
NewStyle предоставляет функцию для создания стиля для ячеек с помощью заданной строки или указателя структуры JSON. Эта функция может быть использована для безопасности параллелизма. Обратите внимание, что поле цвета использует цветовой код RGB.
