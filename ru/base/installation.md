...
Для использования библиотеки Excelize последней версии требуется версия Go 1.25.0 или более поздняя. Обратите внимание, что в Go 1.21.0 есть некоторые [несовместимые изменения](https://github.com/golang/go/issues/61881), эта библиотека не может работать с этой версией. Если вы используете Go 1.21.x, обновитесь до Go 1.21.1 и более поздних версий.
