...
* Fix missing pivot attribute of conditional formatting, problem lösen [#883](https://github.com/xuri/excelize/issues/883)
...
* Vermeiden Sie leere Zeilen im Ende des Arbeitsblatts durch [`GetRows`](https://pkg.go.dev/github.com/360EntSecGroup-Skylar/excelize/v2@v2.4.1#File.GetRows), problem lösen [#842](https://github.com/xuri/excelize/issues/842)
