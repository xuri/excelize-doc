# Volumen-Eröffnungs-Hoch-Tief-Schluss Aktienchart {#stockVolumeOpenHighLowClose}

Fügen Sie beispielsweise ein Volumen-Eröffnungs-Hoch-Tief-Schluss Aktienchart wie dieses hinzu:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="Erstelle Volumen-Eröffnungs-Hoch-Tief-Schluss Aktienchart mit Excelize in der Sprache Go"></p>
...
func main() {
    ...
    for idx, row := range [][]interface{}{
        {"Datum", "Volumen", "Eröffnung", "Hoch", "Tief", "Schluss"},
    ...
    if err := f.AddChart("Tabelle1", "G1", &excelize.Chart{
        Type: excelize.Col,
        ...
        Title: []excelize.RichTextRun{
            {Text: "Volumen-Eröffnungs-Hoch-Tief-Schluss Aktienchart"},
        },
    }, &excelize.Chart{
