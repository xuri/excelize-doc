...
* サードパーティの依存関係を使用する [github.com/mohae/deepcopy](github.com/mohae/deepcopy) ワークシートのディープコピーを実行して、[encoding/gob](https://go.dev/blog/gob) のシリアル化と逆シリアル化に基づいて内部 `deepcopy` を置き換えます
