...
* [グラフ](chart.md)
  ...
  * [株価チャート (高値-安値-終値)](chart/stockHighLowClose.md)
  * [株価チャート (始値-高値-安値-終値)](chart/stockOpenHighLowClose.md)
  * [株価チャート (出来高-高値-安値-終値)](chart/stockVolumeHighLowClose.md)
  * [株価チャート (出来高-始値-高値-安値-終値)](chart/stockVolumeOpenHighLowClose.md)
...
* [ストリーミング書き込み](stream.md)
  ...
  * [ストリーム内の列のアウトラインを設定する](stream.md#SetColOutlineLevel)
  * [ストリームの列スタイルを設定する](stream.md#SetColStyle)
  * [ストリームの列幅を設定する](stream.md#SetColWidth)
  * [ストリーム内の列の表示設定](stream.md#SetColVisible)
...
* [ツール機能](utils.md)
  * [テーブルの追加](utils.md#AddTable)
  * [テーブルの取得](utils.md#GetTables)
  * [テーブルの削除](utils.md#DeleteTable)
  ...
  * [条件付きスタイルを作成する](utils.md#NewConditionalStyle)
  * [条件付きスタイルを取得する](utils.md#GetConditionalStyle)
