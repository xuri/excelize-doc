# Gráfico de acciones Volumen-Máximo-Mínimo-Cierre {#stockVolumeHighLowClose}

Por ejemplo, agregue un Gráfico de acciones Volumen-Máximo-Mínimo-Cierre como este:

<p align="center"><img width="823" src="../images/stock_volume_high_low_close_chart.png" alt="crear un Gráfico de acciones Volumen-Máximo-Mínimo-Cierre con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    for idx, row := range [][]interface{}{
        {"Fecha", "Volumen", "Alto", "Bajo", "Cierre"},
    ...
    if err := f.AddChart("Hoja1", "F1", &excelize.Chart{
        Type: excelize.Col,
        ...
        Title: []excelize.RichTextRun{
            {Text: "Gráfico de acciones Volumen-Máximo-Mínimo-Cierre"},
        },
    }, &excelize.Chart{
