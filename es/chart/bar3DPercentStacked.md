# Gráfico de barras 3D 100% apilado {#bar3DPercentStacked}

Por ejemplo, agregue un Gráfico de barras 3D 100% apilado como este:

<p align="center"><img width="771" src="../images/3d_percent_stacked_bar_chart.png" alt="crear un Gráfico de barras 3D 100% apilado con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "E1", `{
        ...
        "title":
        {
            "name": "Gráfico de barras 3D 100% apilado"
        },
        "plotarea":
        {
