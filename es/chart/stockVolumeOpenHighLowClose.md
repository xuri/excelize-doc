# Gráfico de acciones Volumen-Apertura-Máximo-Mínimo-Cierre {#stockVolumeOpenHighLowClose}

Por ejemplo, agregue un Gráfico de acciones Volumen-Apertura-Máximo-Mínimo-Cierre como este:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="crear un Gráfico de acciones Volumen-Apertura-Máximo-Mínimo-Cierre con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    for idx, row := range [][]interface{}{
        {"Fecha", "Volumen", "Apertura", "Alto", "Bajo", "Cierre"},
    ...
    if err := f.AddChart("Hoja1", "G1", &excelize.Chart{
        Type: excelize.Col,
        ...
        Title: []excelize.RichTextRun{
            {Text: "Gráfico de acciones Volumen-Apertura-Máximo-Mínimo-Cierre"},
        },
    }, &excelize.Chart{
        ...
        Series: []excelize.ChartSeries{
            ...
            },
            {
                Name:       "Hoja1!$E$1",
                Categories: "Hoja1!$A$2:$A$22",
                Values:     "Hoja1!$E$2:$E$22",
            },
            {
                Name:       "Hoja1!$F$1",
                Categories: "Hoja1!$A$2:$A$22",
                Values:     "Hoja1!$F$2:$F$22",
            },
        },
