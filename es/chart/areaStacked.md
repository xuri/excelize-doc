# Gráfico de áreas apiladas 2D {#areaStacked}

Por ejemplo, agregue un Gráfico de áreas apiladas 2D como este:

<p align="center"><img width="770" src="../images/2d_stacked_area_chart.png" alt="crear un Gráfico de áreas apiladas 2D con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "E1", &excelize.Chart{
        ...
        Title: excelize.ChartTitle{
            Name: "Gráfico de áreas apiladas 2D",
        },
