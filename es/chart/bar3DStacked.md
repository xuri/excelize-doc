# Gráfico de barras apiladas 3D {#bar3DStacked}

Por ejemplo, agregue un Gráfico de barras apiladas 3D como este:

<p align="center"><img width="771" src="../images/3d_stacked_bar_chart.png" alt="crear un Gráfico de barras apiladas 3D con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Gráfico de barras apiladas 3D",
            },
        },
