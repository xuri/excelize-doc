# Gráfico de columnas apiladas 2D {#colStacked}

Por ejemplo, agregue un Gráfico de columnas apiladas 2D como este:

<p align="center"><img width="771" src="../images/2d_stacked_column_chart.png" alt="crear un Gráfico de columnas apiladas 2D con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "E1", &excelize.Chart{
        ...
        Title: excelize.ChartTitle{
            Name: "Gráfico de columnas apiladas 2D",
        },
