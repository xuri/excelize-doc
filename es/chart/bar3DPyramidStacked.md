# Gráfico de barras apiladas pirámide 3D {#bar3DPyramidStacked}

Por ejemplo, agregue un Gráfico de barras apiladas pirámide 3D como este:

<p align="center"><img width="771" src="../images/3d_pyramid_stacked_bar_chart.png" alt="crear un Gráfico de barras apiladas pirámide 3D con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "E1", &excelize.Chart{
        ...
        Title: excelize.ChartTitle{
            Name: "Gráfico de barras apiladas pirámide 3D",
        },
