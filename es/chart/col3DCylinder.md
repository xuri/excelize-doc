# Gráfico de columnas de cilindros 3D {#col3DCylinder}

Por ejemplo, agregue un Gráfico de columnas de cilindros 3D como este:

<p align="center"><img width="771" src="../images/3d_cylinder_column_chart.png" alt="crear un Gráfico de columnas de cilindros 3D con excelize usando el lenguaje Go"></p>
