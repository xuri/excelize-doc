# Gráfico de columnas de cono 3D {#col3DCone}

Por ejemplo, agregue un Gráfico de columnas de cono 3D como este:

<p align="center"><img width="771" src="../images/3d_cone_column_chart.png" alt="crear un Gráfico de columnas de cono 3D con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Gráfico de columnas de cono 3D",
            },
        },
