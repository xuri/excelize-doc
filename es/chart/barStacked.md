# Gráfico de barras apiladas 2D {#barStacked}

Por ejemplo, agregue un Gráfico de barras apiladas 2D como este:

<p align="center"><img width="771" src="../images/2d_stacked_bar_chart.png" alt="crear un Gráfico de barras apiladas 2D con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "E1", `{
        ...
        "title":
        {
            "name": "Gráfico de barras apiladas 2D"
        },
        "plotarea":
        {
