# Gráfico de columnas 3D {#col3D}

Por ejemplo, agregue un Gráfico de columnas 3D como este:

<p align="center"><img width="771" src="../images/3d_column_chart.png" alt="crear un Gráfico de columnas 3D con excelize usando el lenguaje Go"></p>
