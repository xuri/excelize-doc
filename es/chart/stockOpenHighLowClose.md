# Gráfico de acciones de Apertura-Alta-Baja-Cierre {#stockOpenHighLowClose}

Por ejemplo, agregue un Gráfico de acciones de Apertura-Alta-Baja-Cierre como este:

<p align="center"><img width="823" src="../images/stock_open_high_low_close_chart.png" alt="crear un Gráfico de acciones de Apertura-Alta-Baja-Cierre con excelize usando el lenguaje Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Hoja1", "F1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {Text: "Gráfico de acciones de Apertura-Alta-Baja-Cierre"},
        },
