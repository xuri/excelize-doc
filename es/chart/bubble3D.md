# Gráfico de burbujas 3D {#bubble3D}

Por ejemplo, agregue un Gráfico de burbujas 3D como este:

<p align="center"><img width="771" src="../images/3d_bubble_chart.png" alt="crear un Gráfico de burbujas 3D con excelize usando el lenguaje Go"></p>
