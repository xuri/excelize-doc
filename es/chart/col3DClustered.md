# Gráfico de columnas agrupadas 3D {#col3DClustered}

Por ejemplo, agregue un Gráfico de columnas agrupadas 3D como este:

<p align="center"><img width="771" src="../images/3d_clustered_column_chart.png" alt="crear un Gráfico de columnas agrupadas 3D con excelize usando el lenguaje Go"></p>
