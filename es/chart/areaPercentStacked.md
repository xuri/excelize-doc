# Gráfico de área 2D 100% apilada {#areaPercentStacked}

Por ejemplo, agregue un Gráfico de área 2D 100% apilada como este:

<p align="center"><img width="770" src="../images/2d_percent_stacked_area_chart.png" alt="crear un Gráfico de área 2D 100% apilada con excelize usando el lenguaje Go"></p>
