# Gráfico de barras de cono 3D 100% {#bar3DConePercentStacked}

Por ejemplo, agregue un Gráfico de barras de cono 3D 100% como este:

<p align="center"><img width="771" src="../images/3d_cone_percent_stacked_bar_chart.png" alt="crear un Gráfico de barras de cono 3D 100% con excelize usando el lenguaje Go"></p>
