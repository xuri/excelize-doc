...
* Corrija la ruta de archivo no válida y el espacio de nombres duplicado al volver a crear la hoja de trabajo, resuelva el problema [#834](https://github.com/xuri/excelize/issues/834)
...
* Evite filas vacías en la parte final de la hoja de trabajo por [`GetRows`](https://pkg.go.dev/github.com/360EntSecGroup-Skylar/excelize/v2@v2.4.1#File.GetRows), resuelva el problema [#842](https://github.com/xuri/excelize/issues/842)
* Arregle la celda de fórmula que falta al obtener el valor de las filas, resuelva el problema [#855](https://github.com/xuri/excelize/issues/855)
* Reparar la comparación falla dentro y fuera de la función IF, resolver el problema [#858](https://github.com/xuri/excelize/issues/858)
...
* Corregir el alcance incorrecto al obtener el nombre definido
