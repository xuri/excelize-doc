...
* Se han agregado nuevos 5 errores exportados `ErrStreamSetPanes`, `ErrSheetNameBlank`, `ErrSheetNameInvalid`, `ErrSheetNameLength` y `ErrSheetNameSingleQuote`
