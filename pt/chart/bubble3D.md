# Gráfico de bolhas 3D {#bubble3D}

Por exemplo, adicione um gráfico de bolhas 3D semelhante a este:

<p align="center"><img width="770" src="../images/3d_bubble_chart.png" alt="crie um gráfico de bolhas 3D com Excelize usando Go"></p>
