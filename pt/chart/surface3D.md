# Gráfico de superfície 3D {#surface3D}

Por exemplo, adicione um gráfico de superfície 3D semelhante a este:

<p align="center"><img width="770" src="../images/3d_surface_chart.png" alt="crie gráfico de superfície 3D com Excelize usando Go"></p>
