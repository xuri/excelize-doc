# Gráfico de colunas empilhadas 2D {#colStacked}

Por exemplo, adicione um gráfico de colunas empilhadas 2D semelhante a este:

<p align="center"><img width="770" src="../images/2d_stacked_column_chart.png" alt="crie um gráfico de colunas empilhadas 2D com Excelize usando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Planilha1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Gráfico de colunas empilhadas 2D",
            },
        },
