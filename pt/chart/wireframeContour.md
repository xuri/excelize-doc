...
<p align="center"><img width="770" src="../images/wireframe_contour_chart.png" alt="crie gráfico de contorno de wireframe com Excelize usando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Planilha1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "gráfico de contorno de wireframe",
            },
        },
    }); err != nil {
        fmt.Println(err)
