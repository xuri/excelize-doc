# Gráfico de colunas 3D {#col3D}

Por exemplo, adicione um gráfico de colunas 3D semelhante a este:

<p align="center"><img width="770" src="../images/3d_column_chart.png" alt="crie gráfico de colunas 3D com Excelize usando Go"></p>
