# Gráfico de barras 3D 100% empilhadas {#bar3DPercentStacked}

Por exemplo, adicione um gráfico de barras 3D 100% empilhado assim:

<p align="center"><img width="769" src="../images/3d_percent_stacked_bar_chart.png" alt="crie um gráfico de barras 3D 100% empilhado com Excelize usando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Planilha1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Gráfico de barras 3D 100% empilhadas",
            },
        },
