# Gráfico de barras empilhadas 2D {#barStacked}

Por exemplo, adicione um gráfico de barras empilhadas 2D semelhante a este:

<p align="center"><img width="770" src="../images/2d_stacked_bar_chart.png" alt="crie um gráfico de barras empilhadas 2D com Excelize usando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Planilha1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Gráfico de barras empilhadas 2D",
            },
        },
