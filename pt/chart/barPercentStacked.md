# Gráfico de barras 2D 100% empilhadas {#barPercentStacked}

Por exemplo, adicione um gráfico de barras 2D 100% empilhado assim:

<p align="center"><img width="770" src="../images/2d_percent_stacked_bar_chart.png" alt="crie um gráfico de barras 2D 100% empilhado com Excelize usando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Planilha1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Gráfico de barras 2D 100% empilhadas",
            },
        },
