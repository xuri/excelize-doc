# Gráfico de área 2D {#area}

Por exemplo, adicione um gráfico de área 2D semelhante a este:

<p align="center"><img width="770" src="../images/2d_area_chart.png" alt="crie gráfico de área 2D com Excelize usando Go"></p>
...
func main() {
    ...
    if err := f.AddChart("Planilha1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {
                Text: "Gráfico de área 2D de frutas",
            },
        },
