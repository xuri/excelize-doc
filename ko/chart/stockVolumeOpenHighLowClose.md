# 거래량-시가-고가-저가-종가 주식 차트 {#stockVolumeOpenHighLowClose}

예를 들어 다음과 같은 거래량-시가-고가-저가-종가 주식 차트 를 추가합니다:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="Go 언어를 사용하여 엑셀리즈로 거래량-시가-고가-저가-종가 주식 차트 만들기"></p>
