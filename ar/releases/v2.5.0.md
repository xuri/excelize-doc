...
* تحسين أداء القراءة المتدفقة ، وفك ضغط جدول السلسلة المشتركة إلى ملف مؤقت للنظام عند وجود XML داخلي كبير ، وانخفاض استخدام الذاكرة حوالي 60٪ ، قضية ذات صلة [#1096](https://github.com/xuri/excelize/issues/1096)
