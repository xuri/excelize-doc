...
يُحدد حقل `TableSheet` اسم ورقة العمل الخاصة بالجدول أو الجدول المحوري، وهذا الإعداد إلزامي.

يُحدد حقل `TableName` اسم الجدول أو الجدول المحوري، وهذا الإعداد إلزامي.
...
يُستخدم خيار `SelectedItems` لتحديد العناصر المُحددة افتراضيًا في أداة التصفية. وهو مدعوم حاليًا فقط لأدوات التصفية في الجداول المحورية. يجب أن تقع العناصر المُحددة ضمن نطاق العناصر المُحددة في الجدول المحوري. إذا تم إنشاء الجدول المحوري باستخدام الدالة [`AddPivotTable`](pivot.md#AddPivotTable) ، فيجب أيضًا تحديد نطاق العناصر المُحددة في الحقل نفسه عند إنشاء الجدول المحوري.
