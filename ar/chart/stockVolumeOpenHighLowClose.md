# رسم بياني للأسهم: الحجم-الافتتاح-الأعلى-الأدنى-الإغلاق {#stockVolumeOpenHighLowClose}

على سبيل المثال ، أضف رسم بياني للأسهم: الحجم-الافتتاح-الأعلى-الأدنى-الإغلاق مثل هذا:

<p align="center"><img width="876" src="../images/stock_volume_open_high_low_close_chart.png" alt="إنشاء رسم بياني للأسهم: الحجم-الافتتاح-الأعلى-الأدنى-الإغلاق باستخدام برنامج excelize باستخدام لغة Go"></p>
...
func main() {
    ...
    for idx, row := range [][]interface{}{
        {"التاريخ", "الحجم", "الافتتاح", "الارتفاع", "الانخفاض", "الإغلاق"},
    ...
    if err := f.AddChart("ورقة1", "G1", &excelize.Chart{
        Type: excelize.Col,
        ...
        Title: []excelize.RichTextRun{
            {Text: "رسم بياني للأسهم: الحجم-الافتتاح-الأعلى-الأدنى-الإغلاق"},
        },
    }, &excelize.Chart{
