# مخطط مساحي ثلاثي الأبعاد {#area3D}

على سبيل المثال ، أضف مخطط مساحي ثلاثي الأبعاد مثل هذا:

<p align="center"><img width="771" src="../images/3d_area_chart.png" alt="إنشاء مخطط مساحي ثلاثي الأبعاد باستخدام برنامج excelize باستخدام لغة Go"></p>
