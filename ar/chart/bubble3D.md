# مخطط فقاعي ثلاثي الأبعاد {#bubble3D}

على سبيل المثال ، أضف مخطط فقاعي ثلاثي الأبعاد مثل هذا:

<p align="center"><img width="771" src="../images/3d_bubble_chart.png" alt="إنشاء مخطط فقاعي ثلاثي الأبعاد باستخدام برنامج excelize باستخدام لغة Go"></p>
