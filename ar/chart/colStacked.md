# مخطط عمودي مكدس ثنائي الأبعاد {#colStacked}

على سبيل المثال ، أضف مخطط عمودي مكدس ثنائي الأبعاد مثل هذا:

<p align="center"><img width="770" src="../images/2d_stacked_column_chart.png" alt="إنشاء مخطط عمودي مكدس ثنائي الأبعاد باستخدام برنامج excelize باستخدام لغة Go"></p>
...
func main() {
    ...
    if err := f.AddChart("ورقة1", "E1", `{
        ...
        "title":
        {
            "name": "مخطط عمودي مكدس ثنائي الأبعاد"
        },
        "plotarea":
        {
