# مخطط شريطي مكدس ثنائي الأبعاد بنسبة 100٪ {#barPercentStacked}

على سبيل المثال ، أضف مخطط شريطي مكدس ثنائي الأبعاد بنسبة 100٪ مثل هذا:

<p align="center"><img width="771" src="../images/2d_percent_stacked_bar_chart.png" alt="إنشاء مخطط شريطي مكدس ثنائي الأبعاد بنسبة 100٪ باستخدام برنامج excelize باستخدام لغة Go"></p>
