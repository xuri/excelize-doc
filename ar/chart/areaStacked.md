# مخطط مساحي مكدس ثنائي الأبعاد {#areaStacked}

على سبيل المثال ، أضف مخطط مساحي مكدس ثنائي الأبعاد مثل هذا:

<p align="center"><img width="771" src="../images/2d_stacked_area_chart.png" alt="إنشاء xxx باستخدام برنامج excelize باستخدام لغة Go"></p>
