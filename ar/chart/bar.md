# مخطط شريطي متفاوت الأبعاد ثنائي الأبعاد {#bar}

على سبيل المثال ، أضف مخطط شريطي متفاوت الأبعاد ثنائي الأبعاد مثل هذا:

<p align="center"><img width="771" src="../images/2d_clustered_bar_chart.png" alt="إنشاء مخطط شريطي متفاوت الأبعاد ثنائي الأبعاد باستخدام برنامج excelize باستخدام لغة Go"></p>
