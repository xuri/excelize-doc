# مخطط سطحي ثلاثي الأبعاد {#surface3D}

على سبيل المثال ، أضف مخطط سطحي ثلاثي الأبعاد مثل هذا:

<p align="center"><img width="772" src="../images/3d_surface_chart.png" alt="إنشاء مخطط سطحي ثلاثي الأبعاد باستخدام برنامج excelize باستخدام لغة Go"></p>
