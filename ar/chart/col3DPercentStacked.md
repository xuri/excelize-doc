# مخطط عمودي مكدس ثلاثي الأبعاد 100٪ {#col3DPercentStacked}

على سبيل المثال ، أضف مخطط عمودي مكدس ثلاثي الأبعاد 100٪ مثل هذا:

<p align="center"><img width="772" src="../images/3d_percent_stacked_column_chart.png" alt="إنشاء مخطط عمودي مكدس ثلاثي الأبعاد 100٪ باستخدام برنامج excelize باستخدام لغة Go"></p>
...
func main() {
    ...
    if err := f.AddChart("ورقة1", "E1", `{
        ...
        "title":
        {
            "name": "مخطط عمودي مكدس ثلاثي الأبعاد 100٪"
        },
        "plotarea":
        {
