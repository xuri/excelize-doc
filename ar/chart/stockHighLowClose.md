# رسم بياني لأسعار الأسهم: أعلى-أدنى-إغلاق {#stockHighLowClose}

على سبيل المثال ، أضف رسم بياني لأسعار الأسهم: أعلى-أدنى-إغلاق مثل هذا:

<p align="center"><img width="770" src="../images/stock_high_low_close_chart.png" alt="إنشاء رسم بياني لأسعار الأسهم: أعلى-أدنى-إغلاق باستخدام برنامج excelize باستخدام لغة Go"></p>
...
func main() {
    ...
    if err := f.AddChart("ورقة1", "E1", &excelize.Chart{
        ...
        Title: []excelize.RichTextRun{
            {Text: "رسم بياني لأسعار الأسهم: أعلى-أدنى-إغلاق"},
        },
