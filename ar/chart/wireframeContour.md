# مخطط كفاف الإطار السلكي {#wireframeContour}

على سبيل المثال ، أضف مخطط كفاف الإطار السلكي مثل هذا:

<p align="center"><img width="771" src="../images/wireframe_contour_chart.png" alt="إنشاء مخطط كفاف الإطار السلكي باستخدام برنامج excelize باستخدام لغة Go"></p>
